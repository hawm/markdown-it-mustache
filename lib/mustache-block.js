...
function tokenizeMustacheBlock(state, startLine, endLine, silent) {
  ...
  if (!silent) {
    const openToken = state.push("mustache_open", "div", 1);
    ...
    state.push("mustache_close", "div", -1);
  }
...
export function mustacheBlock(md) {
  md.block.ruler.after("fence", "mustache-block", tokenizeMustacheBlock, {
